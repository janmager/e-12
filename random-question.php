<?php
  ...
  // WYLOSOWANE PYTANIE
  $randDATA = mysqli_query($conn,"SELECT * FROM `questions-abcd` WHERE id = $randID");
...
<html>
  ...
  <body onload="checkimg()">
    <div class="container container-show randOneQuest" onload="">
      ...
      <div class="c c4">
        <h3>LOSOWE PYTANIE #<span class="rand-quest-id"><?php echo $randID ?></span></h3>
        ...
        <div class="btn-check btn-check-anwser" onclick="checkAnswerRandOne()"></div>
        <div class="btns">
          <div class="btn-rand-new-one"></div>
